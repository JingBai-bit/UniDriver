...
dir="output_dir/driveract/8f_05131941"
...
python ../main_fold_floaps_metric.py \
    ...
    --warmup_epochs 2 \
    --eval_freq 2 \
    --label_csv "../lists/driveract_16/driveract_labels.csv" \
    --mlm_label "../lists/driveract_16/driveract_mlm_labels.txt" \
